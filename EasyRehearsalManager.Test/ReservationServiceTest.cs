    ...
    public class ReservationServiceTest
    {
        ...
        public ReservationServiceTest()
        {
            ...
            var reservationsData = new List<Reservation> { 
                new Reservation { Id = 1, Start = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(1).Day, 10, 0, 0),
                                          End = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(1).Day, 11, 0, 0),
                                          UserId = 1, RehearsalRoomId = 1, RehearsalRoom = roomsData.FirstOrDefault(l => l.Id == 1) },
                new Reservation { Id = 2, Start = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(2).Day, 10, 0, 0),
                                          End = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(2).Day, 11, 0, 0),
                                          UserId = 2, RehearsalRoomId = 2, RehearsalRoom = roomsData.FirstOrDefault(l => l.Id == 2) },
                new Reservation { Id = 3, Start = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(3).Day, 10, 0, 0),
                                          End = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(3).Day, 11, 0, 0),
                                          UserId = 3, RehearsalRoomId = 4, RehearsalRoom = roomsData.FirstOrDefault(l => l.Id == 4) },
                new Reservation { Id = 4, Start = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(10).Day, 10, 0, 0),
                                          End = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(10).Day, 11, 0, 0),
                                          UserId = 4, RehearsalRoomId = 1, RehearsalRoom = roomsData.FirstOrDefault(l => l.Id == 1)
                }
            };
            ...
            var reservationEquipmentPairsData = new List<ReservationEquipmentPair>
            {
                ...
                new ReservationEquipmentPair { Id = 4, StudioId = 1, EquipmentId = 1, EquipmentName = "Equipment1", ReservationId = 4}
            };
        ...
        public void GetReservationsTest_ForOwner()
        {
            ...
            Assert.Contains(new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(1).Day, 10, 0, 0), result.Select(l => l.Start));
            Assert.Contains(new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(2).Day, 10, 0, 0), result.Select(l => l.Start));
            Assert.Contains(new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(10).Day, 10, 0, 0), result.Select(l => l.Start));
            Assert.DoesNotContain(new DateTime(2021, 1, 3, 11, 0, 0), result.Select(l => l.End));
            Assert.DoesNotContain(new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(3).Day, 11, 0, 0), result.Select(l => l.End));
        }
        ...
        /// The tested function doesn't save the reservation. It is only for validation.
        ...
        public void ValidateReservaionTest_ResultOK()
        {
            ...
            var result = _service.ValidateReservation(new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(11).Day, 10, 0, 0),
                                                      new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(11).Day, 11, 0, 0), 
                                                      "create", 1, dictionary, 1);
        ...
        public void ValidateReservationTest_ConflictingWhenCreate()
        {
            ...
            {
                Id = 1,
                Start = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(1).Day, 10, 0, 0),
                End = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(1).Day, 11, 0, 0),
                UserId = 1,
                RehearsalRoomId = 1,
                RehearsalRoom = roomsData.FirstOrDefault(l => l.Id == 1)
            }
            */
            var result = _service.ValidateReservation(new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(1).Day, 10, 0, 0),
                                                      new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(1).Day, 11, 0, 0), 
                                                      "create", 1, dictionary, 1);
        ...
        /// to the same date and room as reservation with ID 1 has.
        /// </summary>
        [Fact]
        ...
        public void ValidateReservationTest_EquipmentNotAvailable_NotExistingEquipment()
        {
            ...
            var result = _service.ValidateReservation(new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(6).Day, 10, 0, 0),
                                                      new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(6).Day, 11, 0, 0), 
                                                      "create", 1, dictionary, 1);
        ...
        /// NOTE: currently fails because start time is less than now.
        /// </summary>
        [Fact]
        public void ValidateReservationTest_EquipmentNotAvailable_AllReservedAlready()
        {
            ...
            //existring reservation:
            //new Reservation { Id = 4, Start = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(10).Day, 10, 0, 0),
            //                          End = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(10).Day, 11, 0, 0),
            //                          UserId = 1, RehearsalRoomId = 1, RehearsalRoom = roomsData.FirstOrDefault(l => l.Id == 1) }
            //NOTE: there is only 1 piece of 'Equipment1' in the studio
            var result = _service.ValidateReservation(new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(10).Day, 10, 0, 0),
                                                      new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(10).Day, 11, 0, 0), 
                                                      "create", 1, dictionary, 2);
        ...
        public void AddReservationEquipmentPairTest()
        {
            ...
            ReservationViewModel viewModel = new ReservationViewModel
            {
                ...
                //BandName = "",
                Day = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(1).Day, 0, 0, 0),
                StartHour = 10,
                EndHour = 11
            };
