...
namespace EasyRehearsalManager.Model
{
    public class RehearsalStudio
    {
        ...
        /// <summary>
        /// Location coordinates currently are not in use.
        /// It could be a feature to show the rehearsal studios on the map.
        /// </summary>
        ...
        /// <summary>
        /// Equipments you can book for you rehearsal.
        /// These stuff are not fixed parts of the room.
        /// E. g. keyboard, crash, double pedal, etc.
        /// </summary>
        public ICollection<Equipment> Equipments { get; set; }

        /// <summary>
        /// Opening and closing hours for each week day.
        /// </summary>
        [Range(0, 24)]
